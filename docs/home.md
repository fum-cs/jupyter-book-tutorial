...
- وقتی فایلهای HTML آماده باشن، در هر سایتی، منجمله هاست‌های داخلی میزبانی شوند.
مثلا 
 [برخی مطالب درسی را در runflare ](http://mamintoosi.runflare.run/)
 قرار داده‌ام. 
-  در هنگام عدم دسترسی به اینترنت بین الملل برای مشاهده درست فرمولهای ریاضی باید اسکریپت‌های لازمه در کنار فایل‌های HTML‌قرار داده شوند و فایلهای HTML، اصلاح شوند.
  در فایلهای بالا اسکریپت‌های MathJax را قرار داده‌ام و با یک برنامه پایتون پچ را انجام داده‌ام.
